...
1.Use the Strategy pattern when you want to use different variants of an algorithm within an object 
...
3.Use the pattern to isolate the business logic of a class from the implementation details of algorithms that may
